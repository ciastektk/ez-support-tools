...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder(): TreeBuilder
    {
        ...
        $rootNode = $treeBuilder->root('ez_support_tools');
        ...
        $rootNode
            ->children()
                ->arrayNode('powered_by')
                    ...
                    ->children()
                        ->booleanNode('enabled')
                            ->info('Activates powered by header')
                            ->defaultValue(true)
                        ->end()
                        ->enumNode('release')
                        ...
                        ->scalarNode('custom_name')
                            ->info('Optional config to override the powered by naming determined by the system')
                            ->defaultValue('')
                        ->end()
                    ->end()
                ->end()
